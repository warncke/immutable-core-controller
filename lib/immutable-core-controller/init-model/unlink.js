...
function unlinkModel (controller, args) {
    ...
    queryArgs.where[relation.viaModelIdColumn] = primaryRecord.raw[relation.modelIdColumn]
    // add related model id to where query
    queryArgs.where[relation.viaRelationIdColumn] = relatedRecord.raw[relation.relationIdColumn]
    // do query
