    ...
    this.paths['/'].get = [
        {
            before: function (args) {
                // load records
                return beforeList(controller, args, _.cloneDeep(controller.fields), title, form, links)
            },
            input: input,
            method: function (args) {
                return _.pick(args, ['clear', 'fields', 'form', 'links', 'pager', 'query', 'records', 'result', 'title'])
            },
            methodName: 'list',
            role: role,
        },
 ...
 * @returns {Promise}
 */
function beforeList (controller, args, fields, title, form, links) {
